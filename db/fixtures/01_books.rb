Book.seed(:id,
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/lrg.jpg',
    order_at: '2017-07-01',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/dp1.png',
    order_at: '2017-07-02',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/dp2cover.png',
    order_at: '2017-07-03',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/9784822282387_1L.jpg',
    order_at: '2017-07-04',
    current: false
  },
  {
    ...
    contents: '本書は、システム保守の現場でありがちな、
              ...
              を紹介している書籍です。',
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/51f-xfTWkkL.jpg',
    order_at: '2017-07-05',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/picture_large978-4-87311-557-3.jpeg',
    order_at: '2017-07-06',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/L.png',
    order_at: '2017-07-07',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/picture_large978-4-87311-760-7.jpeg',
    order_at: '2017-07-08',
    current: false
  },
  {
    ...
    image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/picture_large978-4-87311-731-7.jpeg',
    order_at: '2017-07-09',
    current: true
  },
  {
      ...
      image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/51jRrIRLSNL.jpg',
      order_at: '2017-07-10',
      current: true
  },
  {
      ...
      image_path: 'https://s3-ap-northeast-1.amazonaws.com/dodosoft/books/611cFWZK1-L.jpg',
      order_at: '2017-07-11',
      current: true
  },
)
