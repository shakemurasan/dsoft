class Admin::ActivitiesController < Admin::BaseController
  ...
  def create
    @activity = Activity.new(activity_params.merge({ order_at: activity_params[:created_at] }))
    @activity.order_at = Time.current
  ...
  private
    ...
    def activity_params
      params.require(:activity).permit(:times, :alias_title, :contents, :image_path)
    end
end
